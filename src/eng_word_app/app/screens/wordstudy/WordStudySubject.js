...
import WordComponent from '../../components/wordstudy/WordComponent';
...
export default class WordStudySubject extends React.Component {
    ...
    async checkAnswer(_answer) {
        /*
        Keyboard.dismiss();
        if(this.state.answer == '')
            return; */
        this.setState({ answer: _answer }, async () => {
        ...
        return (
            <Container> 
                ...
                <Content style={styles.container}> 
                            ...
                            {
                                this.props.params == null || this.props.params.length == 0 ? null :
                                this.props.params.map((item, index) => (
                                    this.state.cur_problem_no == index + 1 ?
                                    <WordComponent 
                                        cur_problem_status={this.state.cur_problem_status}
                                        checkAnswer={(_answer) => {
